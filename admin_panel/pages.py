...
PAGES = [
    ...
    Page("about", "About us", "about", GROUP_PUBLIC,
         "Who GoodTip is and why it exists."),
    Page("privacy", "Privacy policy", "privacy", GROUP_PUBLIC,
         "What the system holds, why, and who it goes to. Read every clause "
