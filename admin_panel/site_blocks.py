...
HOME = Page(
    ...
    groups=[
        ...
        Group(
            "Ambassadors",
            blocks=[
                Block("home.amb.eyebrow", "Eyebrow", default="Ambassadors"),
                Block("home.amb.heading", "Heading", RICH, default="People who get it."),
                Block("home.amb.sub", "Sub-heading", TEXT, rows=3,
                      default="People who've led teams, built cultures, and know what it takes to "
                              "make an organisation show up for something bigger than the scoreboard."),
                Block("home.amb.a1_photo", "Ambassador 1 — portrait", IMAGE, "img/nick-maxwell.jpg"),
                Block("home.amb.a1_quote", "Ambassador 1 — quote", TEXT, rows=3,
                      default="Same ritual the rooms have always had. Now it leaves something behind."),
                Block("home.amb.a1_name", "Ambassador 1 — name", default="Nick Maxwell"),
                Block("home.amb.a1_role", "Ambassador 1 — role", default="Premiership Captain"),
                Block("home.amb.a2_quote", "Ambassador 2 — quote", TEXT, rows=3,
                      default="The women's game deserves the same Saturday energy, and a cause behind it."),
                Block("home.amb.a2_name", "Ambassador 2 — name", default="Announcing soon"),
                Block("home.amb.a2_role", "Ambassador 2 — role", default="AFLW Ambassador"),
                Block("home.amb.a3_quote", "Ambassador 3 — quote", TEXT, rows=3,
                      default="Footy brings the room together. This gives the room something to play for."),
                Block("home.amb.a3_name", "Ambassador 3 — name", default="Announcing soon"),
                Block("home.amb.a3_role", "Ambassador 3 — role", default="NRL &amp; NRLW Ambassador"),
            ],
        ),
        Group(
            "Charity partners",
